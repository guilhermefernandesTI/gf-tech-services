...
A aplicação permitirá cadastrar clientes, registrar serviços realizados, atualizar informações e excluir registros utilizando operações CRUD (Create, Read, Update e Delete).
